...
type NullableWorkspaceIdRequestBody struct {
	value *WorkspaceIdRequestBody
	isSet bool
}

func (v NullableWorkspaceIdRequestBody) Get() *WorkspaceIdRequestBody {
	return v.value
}

func (v *NullableWorkspaceIdRequestBody) Set(val *WorkspaceIdRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkspaceIdRequestBody) IsSet() bool {
	return v.isSet
}
...
func NewNullableWorkspaceIdRequestBody(val *WorkspaceIdRequestBody) *NullableWorkspaceIdRequestBody {
	return &NullableWorkspaceIdRequestBody{value: val, isSet: true}
}
