...
func (v NullableImportRequestBody) Get() *ImportRequestBody {
	return v.value
}

func (v *NullableImportRequestBody) Set(val *ImportRequestBody) {
	v.value = val
	v.isSet = true
}
...
func NewNullableImportRequestBody(val *ImportRequestBody) *NullableImportRequestBody {
	return &NullableImportRequestBody{value: val, isSet: true}
}
