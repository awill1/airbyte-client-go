...
func (r ApiGetLogsRequest) LogsRequestBody(logsRequestBody LogsRequestBody) ApiGetLogsRequest {
	r.logsRequestBody = &logsRequestBody
	return r
}
...
func (a *LogsApiService) GetLogsExecute(r ApiGetLogsRequest) (**os.File, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/logs/get"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.logsRequestBody == nil {
		return localVarReturnValue, nil, reportError("logsRequestBody is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.logsRequestBody
