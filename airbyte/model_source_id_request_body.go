...
type NullableSourceIdRequestBody struct {
	value *SourceIdRequestBody
	isSet bool
}

func (v NullableSourceIdRequestBody) Get() *SourceIdRequestBody {
	return v.value
}

func (v *NullableSourceIdRequestBody) Set(val *SourceIdRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceIdRequestBody) IsSet() bool {
	return v.isSet
}
...
func NewNullableSourceIdRequestBody(val *SourceIdRequestBody) *NullableSourceIdRequestBody {
	return &NullableSourceIdRequestBody{value: val, isSet: true}
}
