...
func NewInvalidInputExceptionInfo(message string, validationErrors []InvalidInputProperty) *InvalidInputExceptionInfo {
	this := InvalidInputExceptionInfo{}
...
type NullableInvalidInputExceptionInfo struct {
	value *InvalidInputExceptionInfo
	isSet bool
}

func (v NullableInvalidInputExceptionInfo) Get() *InvalidInputExceptionInfo {
	return v.value
}

func (v *NullableInvalidInputExceptionInfo) Set(val *InvalidInputExceptionInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidInputExceptionInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidInputExceptionInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidInputExceptionInfo(val *InvalidInputExceptionInfo) *NullableInvalidInputExceptionInfo {
	return &NullableInvalidInputExceptionInfo{value: val, isSet: true}
}
