...
*/
func (a *OpenapiApiService) GetOpenApiSpec(ctx context.Context) ApiGetOpenApiSpecRequest {
	return ApiGetOpenApiSpecRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OpenapiApiService) GetOpenApiSpecExecute(r ApiGetOpenApiSpecRequest) (**os.File, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenapiApiService.GetOpenApiSpec")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/openapi"
