...
type NullableDestinationReadList struct {
	value *DestinationReadList
	isSet bool
}

func (v NullableDestinationReadList) Get() *DestinationReadList {
	return v.value
}

func (v *NullableDestinationReadList) Set(val *DestinationReadList) {
	v.value = val
	v.isSet = true
}

func (v NullableDestinationReadList) IsSet() bool {
	return v.isSet
}
...
func NewNullableDestinationReadList(val *DestinationReadList) *NullableDestinationReadList {
	return &NullableDestinationReadList{value: val, isSet: true}
}
