...
func (v *AttemptStatus) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := AttemptStatus(value)
	for _, existing := range AllowedAttemptStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid AttemptStatus", value)
}

// NewAttemptStatusFromValue returns a pointer to a valid AttemptStatus
...
func NewAttemptStatusFromValue(v string) (*AttemptStatus, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for AttemptStatus: valid values are %v", v, AllowedAttemptStatusEnumValues)
	}
}
...
func (v NullableAttemptStatus) Get() *AttemptStatus {
	return v.value
}
...
func NewNullableAttemptStatus(val *AttemptStatus) *NullableAttemptStatus {
	return &NullableAttemptStatus{value: val, isSet: true}
}
