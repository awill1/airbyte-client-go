...
type NullableWorkspaceGiveFeedback struct {
	value *WorkspaceGiveFeedback
	isSet bool
}

func (v NullableWorkspaceGiveFeedback) Get() *WorkspaceGiveFeedback {
	return v.value
}

func (v *NullableWorkspaceGiveFeedback) Set(val *WorkspaceGiveFeedback) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkspaceGiveFeedback) IsSet() bool {
	return v.isSet
}
...
func NewNullableWorkspaceGiveFeedback(val *WorkspaceGiveFeedback) *NullableWorkspaceGiveFeedback {
	return &NullableWorkspaceGiveFeedback{value: val, isSet: true}
}
