...
type NullableOperationReadList struct {
	value *OperationReadList
	isSet bool
}

func (v NullableOperationReadList) Get() *OperationReadList {
	return v.value
}

func (v *NullableOperationReadList) Set(val *OperationReadList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableOperationReadList(val *OperationReadList) *NullableOperationReadList {
	return &NullableOperationReadList{value: val, isSet: true}
}
