...
type NullableSourceReadList struct {
	value *SourceReadList
	isSet bool
}

func (v NullableSourceReadList) Get() *SourceReadList {
	return v.value
}

func (v *NullableSourceReadList) Set(val *SourceReadList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSourceReadList(val *SourceReadList) *NullableSourceReadList {
	return &NullableSourceReadList{value: val, isSet: true}
}
